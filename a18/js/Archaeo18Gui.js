...
var a18Gui = new function(){
	...
	*/
	this.openDocument = function(evt,doc,page,type,position,entity){
		var gui = this;
		var candidates = [];
		...
		var openNewWindow = function(){
			...
			gui.updateNames();
			gui.contentWindows[gui.contentWindows.length-1].addTab({
				document: doc,
				page: page,
				type: type,
				position: position,
