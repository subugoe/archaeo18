<?php require_once('head-main.php'); ?>
	...
	<div class="helptopic help-einfuehrung">
	...
	<div class="helptopic help-arbeiten-mit-mehreren-tabs">
		<p> Die Mitschriften können in einer neuen Mappe geöffnet oder in ein und derselben Mappe als
			mehrere Tybs
			abgelegt werden</p>
	</div>

	<div class="helptopic help-suchen">
	...
	<div class="helptopic help-suchen-mit-mehreren-begriffen">
		<p>Bei der Eingabe von mehr als einem Wort wird nach beiden Begriffen gesucht, ohne, dass diese in
			einem
	...
	<div class="helptopic help-arbeiten-mit-den-handschriften">
	...
	<div class="helptopic help-informationen-zu-personen-orten-etc">
	...
	<div class="helptopic help-weitere-ansichten">
		<h4>Thumbnails</h4>
	...
	<div class="helptopic help-automatische-ausrichtung">
	...
	<div class="helptopic help-manuelle-ausrichtung">
		<p> Sie haben die Möglichkeit Ihre Arbeitsoberfläche individuell einzurichten. Es sind beliebig viele
			...
			können beliebig auf der Arbeitsoberfläche angeordnet – meint verschoben, vergrößert, verkleinert
			minimiert – werden.</p>
	</div>
