...
<header>
	<nav>
		<ul>
			<li><a href="./start.php" title="Lorem ipsum dolor sit amet" hreflang="de" id="linkstart">Start</a></li>
			<li><a href="./edition.php" title="Lorem ipsum dolor sit amet" hreflang="de" id="linkedition">Edition</a></li>
			<li><a href="./indices.php" title="Lorem ipsum dolor sit amet" hreflang="de" id="linkindices">Indices</a></li>
			<li><a href="./handschriften.php" title="Lorem ipsum dolor sit amet" hreflang="de" id="linkhandschriften">Handschriften</a></li>
		</ul>
	</nav>
